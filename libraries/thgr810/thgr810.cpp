...
void Thgr810::manchesterEncode(unsigned char encodeByte, bool lastByte)
{
  ...
  const unsigned int desiredDelay = 486;
  //const unsigned int desiredDelay = 488; esp32
  //const unsigned int desiredDelay = 486; pro mini
  // due to processing time, the delay shouldn't be a full desired delay time
  //const unsigned int shorten = 32; esp32
  //const unsigned int shorten = 64; pro mini
  const unsigned int shorten = 64;
